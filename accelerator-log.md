...
{
  "projectName" : "tjwa1",
  "repositoryPrefix" : "harbor.homelab.fynesy.com/test"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [config/*.yaml, Tiltfile, README.md] -> included
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [sample-app-java->tjwa1]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->harbor.homelab.fynes...(truncated)]
...
┃ ┃ ┗ ┗ ┗ ┗  Info Will replace [tanzu-java-web-app->tjwa1]
